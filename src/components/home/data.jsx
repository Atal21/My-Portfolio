...
import "./home.css";
import MySvg1 from "../../assets/hand.svg";
import MySvg2 from "../../assets/send.svg";

const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Lalit
        <svg
                  width="20"
                  height="20"
                  viewBox="0 0 48 48"
      ...
      <h3 className="home__subtitle"> Mobile Application Developer</h3>
      <p className="home__description">I'm a mobile application developer based in Delhi, passionate about creating innovative and user-friendly apps that deliver exceptional digital experiences.</p>
